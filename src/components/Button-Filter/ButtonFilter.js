...
export function ButtonFilter({ text, className = '' }) {
  const button = El({
    element: 'button',
    innerText: text,
    className: `border-[2px] rounded-full font-semibold border-black inline-block px-6 text-4 m-auto py-[5px] whitespace-nowrap filter-button ${className}`,
  });
